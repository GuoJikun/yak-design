<template>
  <div class="ins-step">
    ...
    <div class="ins-step__icon">
      <div
        :class="[
          'ins-step__icon-inner',
          `ins-step__icon-inner-${getCurrStatus}`,
        ]"
      >
        <ins-icon
          name="check2"
          size="16"
          v-if="getCurrStatus === 'finish'"
        ></ins-icon>
        <ins-icon
          name="x"
          size="16"
          v-else-if="getCurrStatus === 'error'"
        ></ins-icon>
    ...
    <div class="ins-step__main">
      <div
        :class="[
          'ins-step__main-title',
          `ins-step__main-title-${getCurrStatus}`,
        ]"
      >
        <slot>{{ title }}</slot>
      </div>
